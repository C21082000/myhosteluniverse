...
class AddBedPage extends StatefulWidget {
  ...
  @override
  State<AddBedPage> createState() => _AddBedPageState();
}
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: _selectedFloor == null 
                    ? [] 
                    : ["Room 101", "Room 102"].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
                onChanged: (value) => setState(() => _selectedRoom = value),
                validator: (value) => value == null ? "Required" : null,
              ),
              const SizedBox(height: 16),
              const Text("Bed Number / ID", style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              TextFormField(
                decoration: InputDecoration(
                  hintText: "e.g. Bed 1 or B1",
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(8)),
                  contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12),
                ),
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Bed added successfully")),
                      );
                    }
                  },
